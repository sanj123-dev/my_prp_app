  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.cardText}>Review weekly and monthly trends to identify where your spend is rising.</Text>
      </View>

      <TouchableOpacity style={styles.button} onPress={() => router.push('/(tabs)/transactions')}>
        <Text style={styles.buttonText}>Open Transactions Analytics</Text>
      </TouchableOpacity>
    </SafeAreaView>
  );
}
...
const styles = StyleSheet.create({
  ...
  button: { backgroundColor: '#4CAF50', borderRadius: 12, alignItems: 'center', paddingVertical: 14 },
